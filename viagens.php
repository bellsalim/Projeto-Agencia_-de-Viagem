          ...
          <div class="row row-sm row-40 row-md-50">
            <div class="col-sm-6 col-md-12 wow fadeInRight">
              ...
              <?php 
                ...
                $mysqli_result = (" SELECT * FROM `pacotes` where `codigo` = ''");
                while($ln = mysqli_fetch_assoc($result)){
                  ?>
                <div class="unit flex-column flex-md-row align-items-md-stretch">
                  <div class="unit-left"><a class="product-big-figure" href="pacote1.php"><img src="images/product-big-1-600x366.jpg" alt="" width="600" height="366"/></a></div>
                  <div class="unit-body">
                    <div class="product-big-body">
                      <h5 class="product-big-title"><a href="pacote1.php"><?php echo $ln['nome'] ?></a></h5>
                      
                      <p class="product-big-text">descrição do tour</p><a class="button button-black-outline button-ujarak" href="pacote1.php">Comprar</a>
            ...
            <div class="col-sm-6 col-md-12 wow fadeInLeft">
              ...
              <?php 
                ...
                while($ln = mysqli_fetch_assoc($result)){
                  ?>
                <div class="unit flex-column flex-md-row align-items-md-stretch">
                  <div class="unit-left"><a class="product-big-figure" href="Pacote2.php"><img src="images/product-big-2-600x366.webp" alt="" width="600" height="366"/></a></div>
                  <div class="unit-body">
                    <div class="product-big-body">
                      <h5 class="product-big-title"><a href="pacote2.php"><?php echo $ln['nome'] ?></a></h5>
                      
                      <p class="product-big-text">descrição do tour</p><a class="button button-black-outline button-ujarak" href="pacote2.php">Comprar</a>
                      <div class="product-big-price-wrap"><span class="product-big-price"><?php echo $ln['valor']; ?></span></div>
                    </div>
                    <?php } ?>
                  </div>
            ...
            <div class="col-sm-6 col-md-12 wow fadeInLeft">
              ...
              <?php 
                ...
                <div class="unit flex-column flex-md-row align-items-md-stretch">
                  ...
                  <div class="unit-body">
                    <div class="product-big-body">
                      <h5 class="product-big-title"><a href="#"><?php echo $ln['nome']; ?>;</a></h5>
                      ...
                      <p class="product-big-text">descrição do tour</p><a class="button button-black-outline button-ujarak" href="#">Buy This Tour</a>
                      <div class="product-big-price-wrap"><span class="product-big-price"><?php echo $ln['valor']; ?></span></div>
                    </div>
                    <?php } ?>
                  </div>
